...
export function Hero() {
    return (
        <section className='h-screen relative  text-white    max-w-screen overflow-x-hidden '>
            <div className="  flex  flex-col h-screen w-full ">
                ...
                <div className='h-[50vh]   w-full  flex  flex-col   justify-center items-center  py-5   z-10'>
                    ...
                    <h2 className='text-center text-white lg:text-xl text-lg font-bold text-shadow-xl  uppercase  '>
